...
<div class="contenido">
    ...
    <table style="margin-left: 2cm; margin-right: 2cm; ">
        ...
        <tr>
            <td style="  border: 1px solid black; border-collapse: collapse; border-radius: 1cm;">
                <b>POSTGRADO E INVESTIGACIÓN</b><br>
                <img src="{{public_path()}}/img/{{$departamentos[10]->firma}}" class="primary">
                <div class="secondary"
                     style=" background-image: url({{public_path()}}/img/{{$departamentos[10]->sello}});"></div>

                <p>{{$departamentos[10]->nombreEncargado}} {{$departamentos[10]->apellidoPEncargado}} {{$departamentos[10]->apellidoMEncargado}}</p>
                <hr style=" margin-left: 0.5cm; margin-right: 0.5cm; ">
                <p>Nombre y firma</p>
            </td>
            <td style="  border: 1px solid black; border-collapse: collapse; border-radius: 1cm;">
